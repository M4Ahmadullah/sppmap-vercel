...
export const ROUTE_CATEGORIES: RouteCategory[] = [
  {
    id: 'tunnels',
    name: 'Tunnels',
    description: 'Underground passage routes',
    routes: [
  ...
  },
  {
    id: 'footbridges',
    name: 'Footbridges',
    description: 'Bridge crossing routes',
    routes: [
  ...
  },
  {
    id: 'roundabouts',
    name: 'Roundabouts',
    description: 'Roundabout navigation routes',
    routes: [
  ...
  },
  {
    id: 'deadends',
    name: 'Dead Ends',
    description: 'Dead end navigation routes',
    routes: [
  ...
  },
  {
    id: 'shortroutes',
    name: 'Short Routes',
    description: 'Quick navigation routes',
    routes: [
  ...
  },
  {
    id: 'cityroutes',
    name: 'City Routes',
    description: 'Urban navigation routes',
    routes: [
  ...
  },
  {
    id: 'otherroutes',
    name: 'Other Routes',
    description: 'Miscellaneous navigation routes',
    routes: [
  ...
  },
  {
    ...
    description: 'Central reservation routes',
    routes: [
  ...
  },
  {
    id: 'closedroads',
    name: 'Closed Roads',
    description: 'Closed road navigation routes',
    routes: [
  ...
  },
  {
    ...
    description: 'Flyover roundabout routes',
    routes: [
  ...
  },
  {
    id: 'footpaths',
    name: 'Footpaths',
    description: 'Footpath navigation routes',
    routes: [
  ...
  },
  {
    id: 'keepingleft',
    name: 'Keeping Left',
    description: 'Keep left navigation routes',
    routes: [
      { id: 'keepingleft1', name: 'Keeping Left 1', category: 'keepingleft', routeNumber: 1, path: '/newtopo/routes/keepingleft1' },
      { id: 'keepingleft2', name: 'Keeping Left 2', category: 'keepingleft', routeNumber: 2, path: '/newtopo/routes/keepingleft2' },
      { id: 'keepingleft3', name: 'Keeping Left 3', category: 'keepingleft', routeNumber: 3, path: '/newtopo/routes/keepingleft3' }
    ]
  },
  {
    id: 'onwayroad',
    name: 'On Way Road',
    description: 'On way road routes',
    routes: [
      { id: 'onwayroad1', name: 'On Way Road 1', category: 'onwayroad', routeNumber: 1, path: '/newtopo/routes/onwayroad1' },
      { id: 'onwayroad2', name: 'On Way Road 2', category: 'onwayroad', routeNumber: 2, path: '/newtopo/routes/onwayroad2' },
      { id: 'onwayroad3', name: 'On Way Road 3', category: 'onwayroad', routeNumber: 3, path: '/newtopo/routes/onwayroad3' },
      { id: 'onwayroad4', name: 'On Way Road 4', category: 'onwayroad', routeNumber: 4, path: '/newtopo/routes/onwayroad4' }
    ]
  },
  {
    id: 'pedestrianzone',
    name: 'Pedestrian Zone',
    description: 'Pedestrian zone routes',
    routes: [
  ...
  },
  {
    id: 'railwaylines',
    name: 'Railway Lines',
    description: 'Railway line routes',
    routes: [
  ...
  },
  {
    id: 'roadsontop',
    name: 'Roads on Top',
    description: 'Roads on top routes',
    routes: [
  ...
  },
  {
    ...
    description: 'Unmarked one way routes',
    routes: [
